...
export default function Bio(){
    return(
        <div>
            ...
            Explore my professional journey further by checking out my projects in my portfolio, or send me an <a href="mailto:grant.terdoslavich@gmail.com">email</a>.</motion.p>
